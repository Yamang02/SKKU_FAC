 ...
 */
export default class ArtworkListManagementDto {
    constructor(data = {}) {
        ...
        // 관계 데이터
        this.artistName = data.artistName || data.userAccount?.name || '작가 미상';
    ...
    /**
     * 작품이 주요 작품인지 여부에 따른 표시 이름을 반환합니다.
     */
    get featuredDisplayName() {
        return this.isFeatured ? '추천 작품' : '일반 작품';
    }
}
